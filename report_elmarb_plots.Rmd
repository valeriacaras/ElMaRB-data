...
messages_per_2007election <- data07elections2 %>% filter(r_name != "Moskva" & value > 0) %>% 
  ggplot(., aes(y = value, x = reorder(r_name, value), fill = variable)) + geom_col() + theme_minimal() + labs(y = "Number of messages in regional media: State Duma elections 2007") + theme(legend.title  = element_blank(), axis.title.y = element_blank()) + scale_fill_discrete(labels =  c("Number of messages on elections", "Number of messages on electoral fraud")) + coord_flip()
...
messages_per_2008_preselection <- data08elections2 %>% filter(r_name != "Moskva" & value > 0) %>% 
  ggplot(., aes(y = value, x = reorder(r_name, value), fill = variable)) + geom_col() + theme_minimal() + labs(y = "Number of messages in regional media: Presidential elections 2012") + theme(legend.title  = element_blank(), axis.title.y = element_blank()) + scale_fill_discrete(labels =  c("Number of messages on elections", "Number of messages on electoral fraud")) + coord_flip()
...
messages_per_2011election <- data11elections2 %>% filter(r_name != "Moskva" & value > 0) %>% 
  ggplot(., aes(y = value, x = reorder(r_name, value), fill = variable)) + geom_col() + theme_minimal() + labs(y = "Number of messages in regional media: State Duma elections 2011") + theme(legend.title  = element_blank(), axis.title.y = element_blank()) + scale_fill_discrete(labels =  c("Number of messages on elections", "Number of messages on electoral fraud")) + coord_flip()
...
messages_per_2016election <- data16elections2 %>% filter(r_name != "Moskva" & value > 0) %>% 
  ggplot(., aes(y = value, x = reorder(r_name, value), fill = variable)) + geom_col() + theme_minimal() + labs(y = "Number of messages in regional media: State Duma elections 2016") + theme(legend.title  = element_blank(), axis.title.y = element_blank()) + scale_fill_discrete(labels =  c("Number of messages on elections", "Number of messages on electoral fraud")) + coord_flip()
...
messages_per_2018_preselection <- data18elections2 %>% filter(r_name != "Moskva" & value > 0) %>% 
  ggplot(., aes(y = value, x = reorder(r_name, value), fill = variable)) + geom_col() + theme_minimal() + labs(y = "Number of messages in regional media: Presidential elections 2018") + theme(legend.title  = element_blank(), axis.title.y = element_blank()) + scale_fill_discrete(labels =  c("Number of messages on elections", "Number of messages on electoral fraud")) + coord_flip()
...
messages_per_2021election <- data21elections2 %>% filter(r_name != "Moskva" & value > 0) %>% 
  ggplot(., aes(y = value, x = reorder(r_name, value), fill = variable)) + geom_col() + theme_minimal() + labs(y = "Number of messages in regional media: State Duma elections 2021") + theme(legend.title  = element_blank(), axis.title.y = element_blank()) + scale_fill_discrete(labels =  c("Number of messages on elections", "Number of messages on electoral fraud")) + coord_flip()
...
grp_elections2021 <-ggplot(data_RUregions, aes(x = per_violmess_all_parl21, y = log(grp_capita2018))) +
  geom_point(aes(label =  r_name), colour = "indianred2", size = 3) + theme_minimal() + labs(y = "Gross regional product in 2018", x = " electoral violations in State  Duma elections 2021") +  geom_smooth(method='loess') 
#grp_elections2021
...
### State Duma elections 2007
```{r, error=FALSE, warning=FALSE,fig.align='left',echo = FALSE,message=FALSE,fig.width=8, fig.height=6}
turnout_mess_2007 <-ggplot(data_RUregions, aes(x = per_violmess_all_parl07, y = turnout_gd2007)) +
...
turnout_mess_2008 <-ggplot(data_RUregions, aes(x = per_violmess_all_pres08, y = turnout_presd_08)) +
...
### State Duma elections 2011
```{r, error=FALSE, warning=FALSE,fig.align='left',echo = FALSE,message=FALSE,fig.width=8, fig.height=6}
turnout_mess_2011 <-ggplot(data_RUregions, aes(x = per_violmess_all_parl11, y = turnout_gd2011)) +
...
### Presidential elections 2012
```{r, error=FALSE, warning=FALSE,fig.align='left',echo = FALSE,message=FALSE,fig.width=8, fig.height=6}
turnout_mess_2012 <-ggplot(data_RUregions, aes(x = per_violmess_all_pres12, y = turnout_presd_2012)) +
...
### State Duma elections 2016
```{r, error=FALSE, warning=FALSE,fig.align='left',echo = FALSE,message=FALSE,fig.width=8, fig.height=6}
turnout_mess_2016 <-ggplot(data_RUregions, aes(x = per_violmess_all_parl16, y = turnout_gd2016)) +
...
### Presidential elections 2018
```{r, error=FALSE, warning=FALSE,fig.align='left',echo = FALSE,message=FALSE,fig.width=8, fig.height=6}
turnout_mess_2018 <-ggplot(data_RUregions, aes(x = per_violmess_all_pres18, y = turnout_presd_2018)) +
...
turnout_mess_2021 <-ggplot(data_RUregions, aes(x = per_violmess_all_parl21, y = turnout_gd2021)) +
